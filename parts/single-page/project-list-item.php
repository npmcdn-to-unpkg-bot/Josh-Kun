...
<div class="project-list__item relative" data-title="<?php the_title(); ?>">
  <a href="<?php the_permalink(); ?>" class="project-title title ajax-link accent covered"></a>
	<div class="fs-row">
    ...
    <span class="fs-cell fs-lg-1 fs-md-1 fs-sm-3"><span class="fs-lg-hide fs-md-hide">Date: </span><?php the_field('year'); ?>&nbsp;</span>
